...
import ActiveTableEmp from "../../component/EmpComp/ActiveTableEmp";
import HistoryTableEmp from "../../component/EmpComp/HistoryTableEmp";
...
function EmployeeTable() {
    ...
    const renderScene = ({ route, jumpTo }: { route: any, jumpTo: any }) => {
        switch (route.key) {
            case 'first':
                return <ActiveTableEmp index={index} />;
            case 'second':
