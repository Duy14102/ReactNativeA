...
GetUI.create({ title: "Hero", image: array, "word.up": "<div>Hi There!</div>", "word.middle": "<div>This Is EatCom</div>", "word.down": "<div>We hope you will have a great experience using our services. Have a good day!</div>" }).catch(() => { })
GetUI.create({ title: "About", image: array2, "word.up": "<div>We started from a small cart with a variety of rice dishes. Time passed and gradually more people got to know us and the name EatCom was born.</div>", "word.middle": "<div>We always feel lucky to have received support from everyone, EatCom always brings diners perfect rice dishes from delicious to clean and beautiful.Thank you for trusting and using our services</div>", "word.down": "<div>Enjoy your dishes, if something happens please report right away. And once again thank you!</div>" }).catch(() => { })
GetUI.create({ title: "Menu", image: array3, "word.up": "<div>Hello and thank you for using our service</div>", "word.middle": "<div>This is a menu containing a number of dishes that you can refer to before enjoying</div>", "word.down": "<div>We hope you have a great experience with our services. Have a nice day and enjoy the food</div>" }).catch(() => { })
GetUI.create({ title: "Footer", "word.up": "<div>18 Tam Trinh, Ha Noi, Viet Nam</div>", "word.middle": "<div>+012 345 67890</div>", "word.down": "<div>FreeFire@SDTHT.com</div>", "word.time": "<div>9AM - 10PM</div>" }).catch(() => { })
