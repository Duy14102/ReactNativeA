import { ScrollView, View, RefreshControl, Text, Image, TouchableOpacity, useWindowDimensions, ActivityIndicator, StyleSheet } from "react-native";
...
function MenuChange({ index }: { index: any }) {
                                    ...
                                    a.name === "lsneuszzbne2v2iyecaj" ? (
                                        <View key={a.name} style={style.shadow}>
                                            <View style={{ padding: 15, height: "100%" }}>
                                                <Image source={{ uri: image ? image : a.url }} style={{ width: "100%", height: 333, resizeMode: "contain" }} />
                            ...
                            {i.image?.map((a: any) => {
                                return (
                                    a.name === "lwur9bwvniiygtyu6daf" ? (
                                        <View key={a.name} style={style.shadow}>
                                            <View style={{ padding: 15, height: "100%" }}>
                                                <Image source={{ uri: image2 ? image2 : a.url }} style={{ width: "100%", height: 333, resizeMode: "contain" }} />
